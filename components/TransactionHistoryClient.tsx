...
const TransactionHistoryClient = ( {account, currentTransactions, totalPages, currentPage}: TransactionHistoryClientParams ) => {
                ...
                <section className='flex w-full flex-col gap-6'>
                    ...
                    {totalPages > 1 && (
                            <div className='my-4 w-full'>
                                <Pagination totalPages={totalPages} page={currentPage} setIsLaoading={setIsLoading}/>
                            </div>
                        )}
                </section>
            </div>
