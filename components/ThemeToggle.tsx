    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="center" className="bg-white dark:bg-[#121212]">
                <DropdownMenuItem onClick={() => setTheme("light")} className="dark:hover:bg-[#191919] cursor-pointer">
                    Light
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setTheme("dark")} className="dark:hover:bg-[#191919] cursor-pointer">
                    Dark
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setTheme("system")} className="dark:hover:bg-[#191919] cursor-pointer">
                    System
                </DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
